                ...
                <TabPanels>
                  ...
                  <TabPanel>
                    <Text fontSize="xl" mt="4">
                      ...
                      فلسطين. عمل مع منظمات حقوق الإنسان في إسرائيل وشرق إفريقيا
                      ، ويسعى حاليًا للحصول على درجة الدكتوراه في التاريخ
                      الأفريقي في جامعة دورهام.
                    </Text>
                  </TabPanel>
                  <TabPanel whiteSpace="pre-line">
                    {/* <List mt="4">
                  ...
                  <TabPanel>
                    <Text fontSize="xl" mt="4">
                      ...
                      ومكتوبة جيدًا وتستند إلى مجموعة واسعة بشكل مثير للإعجاب من
                      المصادر ، تقدم إسرائيل في إفريقيا تحليلًا أصليًا ومحفزًا
                      للفكر وإبداعًا لعلاقات إسرائيل المتطورة مع الدول
                    ...
                    <Text fontSize="xl">
                      إن إسرائيل تعود إلى إفريقيا بطريقة مهمة ، وسياسة إسرائيلية
                      نشطة تجاه إفريقيا آخذة في الظهور ، وتبحث عن حلفاء جدد ،
                      وفرص تجارية جديدة وتعاونات أمنية جديدة. يقدم كتاب يوتام
                      جيدرون وصفًا دقيقًا لهذه التطورات ، ووضعها في سياقها في كل
                      من التاريخ والسياسة الإسرائيلية المعاصرة. مساهمة كبيرة في
                      موضوع تم التغاضي عنه. إيان تايلور ، جامعة سانت أندروز
                    </Text>
                    <Text fontSize="xl">
                      دراسة علمية بارزة عن بُعد مهمل لنهج إسرائيل في العلاقات
                      خارج الشرق الأوسط. تسلط هذه الدراسة الضوء بشكل رسمي على
                      السياق المتطور والطابع المعقد لانخراط إسرائيل مع إفريقيا.
                      محتوياته موثقة جيدًا ، ومتوازنة سياسيًا ، ومكتوبة بوضوح ،
                      ومحللة بوضوح. ريتشارد فولك ، المقرر الخاص السابق للأمم
                      المتحدة المعني بحالة حقوق الإنسان في الأراضي الفلسطينية
                      المحتلة منذ عام 1967
                    </Text>
                    <Text fontSize="xl">
                      يروي هذا الكتاب الجذاب قصة مهمة ، ولكن لا يزال يساء فهمها
                      ، عن تورط إسرائيل في إفريقيا على مدى العقود الماضية. من
                      الدفاع والصناعات الاستخراجية إلى الهجرة ، بالإضافة إلى
                      الطريقة التي يلعب بها الصراع الدبلوماسي على فلسطين
                      والتنافس في كل مكان مع إيران في القارة ، إسرائيل في رؤى
                      إفريقيا تستحق قراءًا واسعًا. ريكاردو سواريس دي أوليفيرا ،
                      جامعة أكسفورد
                    </Text>
                    <Text fontSize="xl">
                      قصة تحالفات إسرائيل الجديدة في القارة الأفريقية غير مروية
                      إلى حد كبير. يقدم لنا جيدرون خدمة بجعلهم موضوع كتابه. تأخذ
                      إسرائيل في إفريقيا مكانها في موجة جديدة من المنح الدراسية
                      التي لا غنى عنها لتقييم مكانة الدول الأفريقية سريعة التغير
                      في العلاقات الدولية. جوني شتاينبرغ ، جامعة أكسفورد
                    </Text>
                  </TabPanel>
                  <TabPanel>
                    <List mt="4">
