  ...
  return (
    <Box mt="100px" mb="100px">
      ...
      >
        ...
        <Text fontSize="2xl" m="4">
          استقطبت المتوسط الكثير من الأسماء العربية الكبيرة، خاصة في عالم
          الرواية، كما تهتمّ الدار كذلك بالدراسات والكتب الفلسفية والفكرية، إنْ
          ترجمةً أو كتابةً في اللغة العربية، وقد نقلت كتباً هامّة إلى القارئ
          العربي لأسماء رائدة في مجالِ تخصصها، وتسعى الدار للمشاركة والتواجد في
          مختلف معارض الكِتاب الدولية، في العالم العربي أو في أوروبا، لتقريب
          الكِتاب في شتّى مجالات الأدب والفكر من القارئ العربي أينما كان.
        </Text>
